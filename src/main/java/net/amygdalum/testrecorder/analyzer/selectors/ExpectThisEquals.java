...
public class ExpectThisEquals<T> implements PropertyKeySelector<T>, MatchLiteralProperties {

	private SerializedValueEvaluator expression;
	private T object;
	private Index<T> index;

	public ExpectThisEquals(String expression, T object, Index<T> index) {
