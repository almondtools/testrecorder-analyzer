...
public class ComputeCoverage implements PropertyUpdate {
	...
	public static final SyntheticProperty<Coverage> COVERAGE = new SyntheticProperty<>(ComputeCoverage.class, "coverage", Coverage.class);

	private SyntheticProperty<SourceCode> sourceCode;
